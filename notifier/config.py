...
ALL_RECIPIENTS = ["Pilot", "Unmooring", "Tugboat", "ShippingAgent", "ShippingCompany", "LoadingUnloading", "PierLIENHAI", "PierSelfOperated"]
STANDARD_RECIPIENTS = ["Unmooring", "Tugboat", "ShippingAgent", "ShippingCompany", "CIQS", "PierLIENHAI", "PierSelfOperated"]
...
notification_mapping: Dict[str, List[str]] = {
    ...
    "實際靠妥時間": ["ShippingAgent", "ShippingCompany", "LoadingUnloading", "CIQS", "PierLIENHAI", "PierSelfOperated"],
    ...
    "離開泊地時間": ["ShippingAgent", "ShippingCompany", "PierLIENHAI", "PierSelfOperated"],
